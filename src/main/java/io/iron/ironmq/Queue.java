...
public class Queue {
    ...
    * @throws IOException If there is an error accessing the IronMQ server.
    */
    public String postMessage(String msg) throws IOException {
        return postMessage(msg, 0);
    }
     ...
     * @throws IOException If there is an error accessing the IronMQ server.
     */
    public Ids postMessages(String[] msg) throws IOException {
    ...
    * @throws IOException If there is an error accessing the IronMQ server.
    */
    public String postMessage(String msg, long timeout) throws IOException {
        return postMessage(msg, timeout, 0);
    }
    ...
    * @throws IOException If there is an error accessing the IronMQ server.
    */
    public String postMessage(String msg, long timeout, long delay) throws IOException {
        return postMessage(msg, timeout, delay, 0);
    }
    ...
    * @throws IOException If there is an error accessing the IronMQ server.
    */
    public String postMessage(String msg, long timeout, long delay, long expiresIn) throws IOException {
